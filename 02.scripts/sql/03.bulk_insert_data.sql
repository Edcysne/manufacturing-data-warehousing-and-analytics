...
-- Use EXEC bronze_layer.procedure_bulk_pub
CREATE OR ALTER PROCEDURE bronze_layer.procedure_bulk_pub AS
BEGIN
    ...
    BEGIN TRY
        ...
        TRUNCATE TABLE bronze_layer.breakdown_data;
        ...
        TRUNCATE TABLE bronze_layer.status_data
