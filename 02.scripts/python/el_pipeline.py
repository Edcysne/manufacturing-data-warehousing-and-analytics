...
#                by Leaders and loads it into the Azure SQL Database.
#
...
#                     - breakdown_data  (stoppage / failure records)
...
# --- PATHS ---
EXCEL_FOLDER = (r'<path-to-reports-folder>'
)
...
SUBFOLDER    = os.path.join(EXCEL_FOLDER, YEAR, MONTH_FOLDER) #03. Mar 2026
...
def run_pipeline() -> None:
    ...
    all_files = sorted(f for f in os.listdir(SUBFOLDER) if f.endswith('.xlsm') and not f.startswith('~$'))
