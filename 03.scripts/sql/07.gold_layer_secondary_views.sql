...
OUTPUT:     fact_status_trash_dev          ->  status rows that break a physical/measurement rule.
            ...
            dim_date_final_dev             ->  conformed dimensions for the dashboard.
            dim_work_stations_final_dev
...
/*
===========================================================
                GOLD LAYER FINAL DATE DIM VIEW
===========================================================
*/

CREATE VIEW gold_layer.dim_date_final_dev AS
SELECT * FROM [db_manufacturing_warehouse].[gold_layer].[dim_date_dev];
GO
