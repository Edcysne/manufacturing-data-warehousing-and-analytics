...
#            Bronze Layer, targeting the wel_breakdown_data and
#            wel_status_data tables.
#
...
BREAKDOWN_FILE = os.path.join(CSV_FOLDER, 'wel_breakdown_data.csv')
STATUS_FILE    = os.path.join(CSV_FOLDER, 'wel_status_data.csv')
